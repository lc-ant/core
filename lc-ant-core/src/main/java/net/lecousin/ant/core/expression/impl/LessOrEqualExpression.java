...
@AllArgsConstructor
@NoArgsConstructor
public class LessOrEqualExpression<T1 extends Serializable, T2 extends Serializable> implements BinaryOperationExpression<T1, T2, Boolean> {

	private static final long serialVersionUID = 1L;
	
	private Expression<T1> leftIsLessOrEqualTo;
	private Expression<? extends T2> right;
	
	@Override
	public Expression<T1> leftOperand() {
		return leftIsLessOrEqualTo;
	}
